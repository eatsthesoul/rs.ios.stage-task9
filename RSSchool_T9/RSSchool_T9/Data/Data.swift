...
struct FillingData {
    static let data: [ContentType] = [
        ...
        .gallery(Gallery(coverImage: .init("mountains-0"), title: "Mountains", images: .init(base: "mountains", count: 7))),
        .gallery(Gallery(coverImage: .init("library-0"), title: "Library", images: .init(base: "library", count: 8))),
